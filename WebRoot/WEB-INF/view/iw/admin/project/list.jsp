...
<head>
	<jsp:include page="../../../publicPage/adminCommon/head.jsp">
    	<jsp:param name="title" value="项目列表"/>
    </jsp:include>
                       ...
                       <!-- <div class="btn-group" style="float: left;">
                        ...
                        <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                                ...
                                <tr>
                                    <th>ID</th>
                                    <th class="numeric">项目名</th>
                                    <th class="numeric">建立时间</th>
                                    <th class="numeric">最后改动的时间</th>
                                    <th class="numeric">状态</th>
                                    <th class="numeric">成员权限</th>
                                ...
                                <c:forEach items="${list}" var="project">
                                	<tr>
	                                    <td>${project.id }</td>
	                                    <td class="numeric">${project.name }</td>
	                                    <td class="numeric"><x:time linuxTime="${project.addtime }" format="yyyy-MM-dd"></x:time></td>
	                                    <td class="numeric"><x:time linuxTime="${project.lasttime }" format="yyyy-MM-dd"></x:time></td>
	                                    <td class="numeric">${project.state }</td>
	                                    <td class="numeric">${project.power }</td>
	                                    <td class="numeric">
                        ...
                        <div class="row"><div class="col-lg-12"><div class="dataTables_paginate paging_bootstrap pagination"><ul><li class="prev disabled"><a href="#">上一页</a></li><li class="active"><a href="#">1</a></li><li><a href="#">2</a></li><li><a href="#">3</a></li><li><a href="#">4</a></li><li><a href="#">5</a></li><li class="next"><a href="#">下一页</a></li></ul></div></div></div>
                    </div>
                </section>
